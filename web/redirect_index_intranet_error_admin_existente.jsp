<%-- 
    Document   : redirect_index_intranet_error_admin_existente
    Created on : Jul 14, 2015, 8:49:39 AM
...
<html>
    <head>
        ...
        <meta http-equiv="refresh" content="3; url=index_intranet.jsp" />
    </head>
            ...
            <div class="w3-col m8">
                ...
                <div class="w3-card-2">
                    ...
                    <h2>Error&nbsp;&nbsp;<i class="fa fa-exclamation-triangle"></i> </h2>
                        ...
                        <br>
                        <h3>El administrador ya se encuentra registrado en la base de datos.</h3>
                        <br>
