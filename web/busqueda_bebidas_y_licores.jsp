<%-- 
    Document   : busqueda_bebidas_y_licores.jsp
...
<html>
    ...
    <body>
        ...
        <%
            ...
            String tipoProducto = "Bebidas y Licores";
            String thisURL = "busqueda_bebidas_y_licores.jsp";
        %>
        ...
        <br>
            ...
            <a class="list-group-item" href="busqueda_alimentos_congelados.jsp"><img src="icons/alimentos_congelados.png" width="30" height="30" alt="alimentos_congelados"/>
                        &nbsp;Alimentos Congelados</a>
            <a class="list-group-item active" href="busqueda_bebidas_y_licores.jsp"><img src="icons/bebidas_y_licores_w.png" width="30" height="30" alt="bebidas_y_licores"/>
                        &nbsp;Bebidas y Licores</a>
            ...
            <div class="w3-col m7 w3-card w3-padding">          
                <div class="w3-container red">
                    <h2>Productos categoría: <%=tipoProducto%>&nbsp;&nbsp; <img src="icons/bebidas_y_licores_w.png" width="50" height="50" alt="bebidas_y_licores_w"/>
                    </h2>
                </div>
