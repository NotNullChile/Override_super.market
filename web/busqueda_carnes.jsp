...
<html>
    ...
    <body>
        ...
        <%
            ...
            String tipoProducto = "Carnes";
            String thisURL = "busqueda_carnes.jsp";
        %>
        ...
        <br>
            ...
            <a class="list-group-item" href="busqueda_bebidas_y_licores.jsp"><img src="icons/bebidas_y_licores.png" width="30" height="30" alt="bebidas_y_licores"/>
                        &nbsp;Bebidas y Licores</a>
            <a class="list-group-item  active" href="busqueda_carnes.jsp"> <img src="icons/carnes_w.png" width="30" height="30" alt="carnes"/>
                        &nbsp;Carnes</a>
            ...
            <div class="w3-col m7 w3-card w3-padding">                     
                <div class="w3-container red">
                    <h2>Productos categoría: <%=tipoProducto%>&nbsp;&nbsp; <img src="icons/carnes_w.png" width="50" height="50" alt="carnes_w"/>
                    </h2>
                </div>
