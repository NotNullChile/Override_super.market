<%-- 
    Document   : busqueda_mascotas.jsp
...
<html>
    ...
    <body>
        ...
        <%
            ...
            String tipoProducto = "Mascotas";
            String thisURL = "busqueda_mascotas.jsp";
        %>
        ...
        <br>
            ...
            <div class="w3-col m7 w3-card w3-padding">                     
                <div class="w3-container red">
                    <h2>Productos categoría: <%=tipoProducto%>&nbsp;&nbsp; <img src="icons/mascotas_w.png" width="50" height="50" alt="mascotas_w"/>
                    </h2>
                </div>
