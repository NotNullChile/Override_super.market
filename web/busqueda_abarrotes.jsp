<%-- 
    Document   : busqueda_abarrotes.jsp
    ...
    <body>
        ...
        <br>
            ...
            <a class="list-group-item" href=index.jsp> <img src="icons/Override.png" width="30" height="30" alt="Override"/>
                &nbsp;Home</a>
            <a class="list-group-item active" href="busqueda_abarrotes.jsp"><img src="icons/abarrotes_w.png" width="30" height="30" alt="abarrotes"/>
                        &nbsp;Abarrotes</a>
            ...
            <div class="w3-col m7 w3-card w3-padding">                       
                <div class="w3-container red">
                    <h2>Productos categoría: <%=tipoProducto%>&nbsp;&nbsp; <img src="icons/abarrotes_w.png" width="50" height="50" alt="abarrotes_w"/>
                    </h2>
                </div>
