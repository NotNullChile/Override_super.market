<%-- 
    Document   : busqueda_busqueda_cereales_y_snacks.jsp
...
<html>
    ...
    <body>
        ...
        <%
            ...
            String tipoProducto = "Cereales y Snacks";
            String thisURL = "busqueda_busqueda_cereales_y_snacks.jsp";
        %>
        ...
        <br>
            ...
            <a class="list-group-item" href="busqueda_carnes.jsp"> <img src="icons/carnes.png" width="30" height="30" alt="carnes"/>
                        &nbsp;Carnes</a>
            <a class="list-group-item  active" href="busqueda_cereales_y_snacks.jsp"> <img src="icons/cereales_y_snacks_w.png" width="30" height="30" alt="hogar_y_limpieza"/>
                        &nbsp;Cereales y Snacks</a>
            ...
            <div class="w3-col m7 w3-card w3-padding">              
                <div class="w3-container red">
                    <h2>Productos categoría: <%=tipoProducto%>&nbsp;&nbsp; <img src="icons/cereales_y_snacks_w.png" width="50" height="50" alt="cereales_y_snacks_w"/>
                    </h2>
                </div>
