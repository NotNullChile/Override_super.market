<%-- 
    Document   : redirect_index_sesion_cerrada
    Created on : Jul 14, 2015, 1:33:32 AM
    ...
    <body>
        ...
        <br>
            ...
            <div class="w3-col m8">
                ...
                <div class="w3-card-2">
                    <div class="w3-col m1">&nbsp;</div>
                    <div class="w3-col m10 alert alert-info">
                        <div class="w3-container deep-purple-d4">
                    <h2>Sesión cerrada&nbsp;&nbsp;<i class="fa fa-user"></i> </h2>
                </div>
                        <br>
